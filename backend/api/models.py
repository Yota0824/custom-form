...
class WebFlyerFlyer(models.Model): #ビラ配布
    school_id = models.CharField(max_length=4)
    school_name = models.CharField(max_length=20)
    total_out = models.IntegerField(max_length=10)  #総枚数
    total_inquiry = models.IntegerField(max_length=10) #問い合わせ総数
    total_consult = models.IntegerField(max_length=10) #受験相談数
    ...
    flyer_count1 = models.IntegerField(max_length=10) #配布枚数
    ...
    flyer_count2 = models.IntegerField(max_length=10)
    ...
    flyer_count3 = models.IntegerField(max_length=10)
